...
public class Tags {
	...
	public static int MAX_MSG_SIZE = 1024000; // 1024kb
	...
	public static String FILE_DATA_BEGIN_TAG = "aW";
	...
	public static int show(JFrame frame, String msg, boolean type) {
            if (type)
                return JOptionPane.showConfirmDialog(frame, msg,"Xác nhận", JOptionPane.YES_NO_OPTION);
