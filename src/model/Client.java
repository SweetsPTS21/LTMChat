...
public class Client {
	...
	private final int timeOut = 10000; // time to each request is 10 seconds.
	...
	public void request() throws Exception {
		...
		// just for test
		System.out.println("Server: " + msg); // test server return to user
	...
	public void intialNewChat(String IP, int host, String guest) throws Exception {
		...
		if (msg.equals(Tags.CHAT_DENY_TAG)) {
			MainJFrame.request("Người dùng từ chối kết nối!", false);
			connclient.close();
			return;
		}
		// if accept connect
