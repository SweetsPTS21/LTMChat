...
public class ChatFrame2 extends javax.swing.JFrame {
    ...
    public void updateChat_receive(String msg) {
        appendToPane(txtDisplayMessage, 
                "<table class='left' style='color: black; clear:both; width: 100%;'>" + "<tr align='left'>"
                        ...
                        + msg + "<br>" + LocalDateTime.now().getHour() + ":" + LocalDateTime.now().getMinute()
    ...
    private void initComponents() {
        ...
        txtDisplayMessage.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
	...
	// Không làm gì khi chưa nhập tin nhắn
	if (msg.equals(""))
            return;        
        txtMessage.setText("");
        //Mã hóa và gửi đi tin nhắn
	try {
		...
		try {
                    ...
                    if (obj instanceof String) {
                        ...
                        if (msgObj.equals(Tags.CHAT_CLOSE_TAG)) {
                            isStop = true;
                            Tags.show(frame, nameGuest + " đã thoát, cửa sổ này sẽ đóng!",false);
                            ...
                            //Giải mã và hiển thị tin nhắn nhận được
